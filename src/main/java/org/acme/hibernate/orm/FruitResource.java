...
public class FruitResource {
    ...
    public List<Fruit> get() {
        ...
        String mapperResourceName = "mybatis/Fruit.xml";
        ...
        mapperParser.parse();
        MappedStatement mappedStatement = configuration.getMappedStatement("FIND_ALL");
		BoundSql boundSql = mappedStatement.getBoundSql(new HashMap<>());
